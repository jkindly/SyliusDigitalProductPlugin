...
final readonly class FileConfigurationSerializer implements FileConfigurationSerializerInterface
{
    ...
    {
        /** @var FileDtoInterface $dto */
        $dto = new $this->dtoClass();
        Assert::isInstanceOf($dto, FileDtoInterface::class);
