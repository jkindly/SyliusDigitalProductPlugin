 ...
 */
final class Version20251129192719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sylius_digital_product_file_channel_settings (id INT AUTO_INCREMENT NOT NULL, channel_id INT NOT NULL, download_limit INT DEFAULT NULL, days_available INT DEFAULT NULL, hidden_quantity TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_954D03EA72F5A1AA (channel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE sylius_digital_product_file_channel_settings ADD CONSTRAINT FK_954D03EA72F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_digital_product_channel_settings ADD CONSTRAINT FK_77D83A5872F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
