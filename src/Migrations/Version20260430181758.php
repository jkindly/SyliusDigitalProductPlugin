...
final class Version20260430181758 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'This migration creates tables for digital products, including channel settings, file management, and order item files.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sylius_digital_product_file (id INT AUTO_INCREMENT NOT NULL, channel_id INT NOT NULL, product_variant_id INT NOT NULL, uuid VARCHAR(36) NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, configuration JSON DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_936063B8D17F50A6 (uuid), INDEX IDX_936063B872F5A1AA (channel_id), INDEX IDX_936063B8A80EF684 (product_variant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_digital_product_file_settings (id INT AUTO_INCREMENT NOT NULL, file_id INT NOT NULL, download_limit INT DEFAULT NULL, days_available INT DEFAULT NULL, UNIQUE INDEX UNIQ_7619087093CB796C (file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_digital_product_order_item_file (id INT AUTO_INCREMENT NOT NULL, order_item_id INT NOT NULL, uuid VARCHAR(36) NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, download_limit INT DEFAULT NULL, download_count INT DEFAULT NULL, configuration JSON DEFAULT NULL, available_until DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_7F30DED17F50A6 (uuid), INDEX IDX_7F30DEE415FB15 (order_item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sylius_digital_product_variant_settings (id INT AUTO_INCREMENT NOT NULL, variant_id INT NOT NULL, enabled TINYINT(1) NOT NULL, hidden_quantity TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_9FB808793B69A9AF (variant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sylius_digital_product_file ADD CONSTRAINT FK_936063B872F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sylius_digital_product_file DROP FOREIGN KEY FK_936063B872F5A1AA');
